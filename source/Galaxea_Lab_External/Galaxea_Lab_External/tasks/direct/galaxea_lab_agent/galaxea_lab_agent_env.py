...
from .galaxea_lab_agent_env_cfg import GalaxeaLabAgentEnvCfg
...
class GalaxeaLabAgentEnv(DirectRLEnv):
    cfg: GalaxeaLabAgentEnvCfg

    def __init__(self, cfg: GalaxeaLabAgentEnvCfg, render_mode: str | None = None, **kwargs):
